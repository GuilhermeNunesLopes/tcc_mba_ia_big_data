...
def main():
    ...
    # ==========================================
    print("\n[1.5/4] Aplicando TruncatedSVD...")
    # Usando o último valor da sua lista (50) ou um valor fixo (100)
    n_comp = 50 
    ...
    # FUSÃO: Matrizes já são densas, usamos np.hstack
    X_train_final = np.hstack((X_train_svd, meta_train))
    X_test_final = np.hstack((X_test_svd, meta_test))
