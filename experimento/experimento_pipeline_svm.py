...
def executar_pipeline_anomalias():
    ...
    df_resultado.to_parquet('resultados/resultado_final_hdfs_svm.parquet', index=False)
    print("\n✅ Predições e Scores salvos em 'resultados/resultado_final_hdfs_svm.parquet'")
