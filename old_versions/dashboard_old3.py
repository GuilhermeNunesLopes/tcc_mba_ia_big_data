...
def main():
    ...
    with col_exp2:
        ...
        if 'y_true_label' in df_final.columns:
            ...
            prec = precision_score(df_final['y_true_label'], df_final['pred_is_anomaly'], zero_division=0)
            rec = recall_score(df_final['y_true_label'], df_final['pred_is_anomaly'], zero_division=0)
            f1_s = f1_score(df_final['y_true_label'], df_final['pred_is_anomaly'], zero_division=0)
